...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="img/logokbih.png">
    <!-- Google Fonts
		============================================ -->
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <img class="main-logo" src="img/siijanur2.png" alt="" />
                <strong><img src="img/siijanur2.png" alt="" /></strong>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <img class="main-logo" src="img/siijanur2.png" alt="" style="width:30%; height:70px;"/>
                    </div>
                </div>
            </div>
        </div>
